...
Object.defineProperties(abWeb, {
    ...
    class abWeb_Ext
    {
        ...
        { let self = this;
            let afterBuildTaskName = `exts.${ext_path}.afterBuild`;
            let buildTaskName = `exts.${ext_path}.build`;
            let cleanTaskName = `exts.${ext_path}.clean`;
            let onChangeTaskName = `exts.${ext_path}.onChange`;
            ...
            Object.defineProperties(this, {
                ...
                _tasks_Build: { value: new abWeb.Task(buildTaskName, () => {
                    return self.__build();
                })},
                ...
                _tasks_OnChange: { value: new abWeb.Task(onChangeTaskName,
                    ...
                    for (let args of argsArr) {
                        ...
                        if (!changes[args[1]].includes(args[2]))
                            changes[args[1]].push(args[2]);
                    }
