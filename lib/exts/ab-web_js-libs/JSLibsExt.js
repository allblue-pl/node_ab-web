...
import ABWebExt, { ExtPrinter } from "../../ABWebExt.js";
                                               
import fs from "node:fs";
import { presets_JSPkgInfos, presets_TSPkgInfos,                                                                 } from "./ts-types.js";
...
export default class JSLibsExt extends ABWebExt {
    ...
    addLib(libName        , libFSPath        , libType           , 
            tsconfigFSPath              = null, legacyJS          = false)       {
    ...
    async #script_Create_Async(scriptInfo            )                   {
    ...
    __getName()         {
        ...
        let errors                = [];
        let tsPkgs = ts0.validateType            (config.tsPkgs, presets_TSPkgInfos,
                errors);
        if (tsPkgs === undefined) {
