...
export default class LayoutBuilder {
    static Build(ext: SpockyExt, layoutPath: string, packagePath: string) {
...
`
    ...
    static AddNode(parentLayoutNode: Array<any>, node: ElemType) {
        if (node.type === 'text') {
    ...
    static ParseFields(content: string) {
        let lTextsArr = [];
